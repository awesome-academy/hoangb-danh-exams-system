...
q = Question.create!(content: "Biến bắt đầu bằng hai ký tự @@ trong Ruby là loại biến nào?",
                     subject_id: 1,
...
q = Question.create!(content: "Lớp cha của lớp String trong Ruby?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Câu lệnh nào sau đây sử dụng biến Instance?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Giá trị của x trong biểu thức x = 100_000 / 100 ?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Kiểu nào sau đây là kiểu nguyên thủy trong Ruby?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Trong Ruby, !!nil có nghĩa là?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "nil.nil? trả về kết quả ra sao?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Câu lệnh nào dưới đây sẽ trả về thời gian hiện
...
q = Question.create!(content: "Symbols trong Ruby có đặc điểm gì?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "A = 5, b = 7. Câu lệnh nào sau đây là không hợp lệ trong Ruby?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Biến Instance trong Ruby không cần được khai báo?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Điều nào sau đây đúng khi nói về Ruby?
...
q = Question.create!(content: "a = 1, b = 2, x = a ||= b. Giá trị của x?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "_lambda = lambda {puts \"Hello World\"},
...
q = Question.create!(content: "$val = 20 print \"Sample Text\" if $val.
...
q = Question.create!(content: "Cách nào sau đây là cách đúng để định nghĩa một
...
q = Question.create!(content: "Giá trị nào được trả về khi bạn truyền một khóa
...
q = Question.create!(content: "Biểu thức nào sau đây không trả về [\"a\", \"b\"]?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "a = 3_1_4_1_5_9_2_6, puts a trả về kết quả?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "colors = {:red => \"FF0000\", :green => \"00FF00\",
...
q = Question.create!(content: "Để kiểm tra một phương thức thuộc một lớp hay không ta sử dụng?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Câu lệnh nào sau đây chứa một symbol?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "x = [1, 1, 2, 3, 5]; y = [2, 4, 16]; z = x | y.
                                Giá trị của z là?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Trong Ruby, nil tương đương với?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
q.answers.build content: "False", is_answer: true
...
q = Question.create!(content: "Kết quả của biểu thức: x = \"A\" + \"B\" puts x
                                                      y = \"C\" << \"D\" puts là?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Truyền một đối tượng lambda vào làm đối số cho
...
q = Question.create!(content: "Chỉ số đầu của mảng trong Ruby?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Kích thước mảng trong Ruby là bao nhiêu?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
q.answers.build content: "10", is_answer: false
...
q = Question.create!(content: "Giá trị của biểu thức y = 2 ** 3?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "-> (a) {p a}[\"Hello World\"]?",
                     subject_id: 1,
                     user_id: Random.rand(1..5))
q.answers.build content: "true", is_answer: false
q.answers.build content: "false", is_answer: true
...
q = Question.create!(content: "Đăng ký kho truy cập từ xa?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Xem trạng thái của kho lưu trữ?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Thay đổi tên tệp?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Sửa commit?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Hển thị nhật ký commit?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Xem nội dung thay đổi?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Xem danh sách các nhánh?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Hiển thị trợ giúp?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Kiểm tra thiết lập?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Đưa nội dung của tệp từ stage trở về HEAD?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Khi đang ở nhánh develop, ghép nhánh br1 vào
                               nhánh develop?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Hiển thị nhật ký trên một dòng?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Tạo và chuyển đến nhánh br1?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Xem sự khác biệt giữa HEAD và stage?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Xem sự khác biệt giữa các commit?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Xem nhật ký thao tác?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
q.answers.build content: "git log", is_answer: false
...
q = Question.create!(content: "Chuyển đến nhánh khác?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Xóa tệp?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Chỉ định tệp rồi hiển thị nhật ký?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Commit tệp staging?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Xem sự khác biệt giữa nhánh đang làm việc và HEAD?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Xem sự khác biệt giữa nhánh đang làm việc và stage?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Chỉ staging foo.txt?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Xóa tệp khỏi stage?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Xóa nhánh work1?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Khi đang ở nhánh work1, rebase nhánh work1 theo
...
q = Question.create!(content: "Xóa nhánh develop trên remote repo?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Gộp n commit lại với nhau?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Thay đổi tên remote?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Kéo nhánh master từ remote repo và merge với
                               branch hiện tại?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
...
q = Question.create!(content: "Liệt kê toàn bộ branch (local + remote repo)?",
                     subject_id: 4,
                     user_id: Random.rand(1..5))
